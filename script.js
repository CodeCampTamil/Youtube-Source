const projects = [
  {
    title: "Code Camp Tamil Website Template",
    category: "fullstack",
    language: "HTML",
    date: "New",
    description:
      "The starter website source code for hosting project downloads on GitHub Pages.",
    tech: ["HTML", "CSS", "Tailwind", "JavaScript"],
    zip: "downloads/code-camp-tamil-website-template.zip",
